...
<!-- Mirrored from pixner.net/sbidu/main/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Oct 2020 09:37:31 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="cart-sidebar-area">
        <div class="top-content">
            <a href="index.html" class="logo">
                <img src="{{asset('front/assets/images/logo/logo2.png')}}" alt="logo">
            </a>
        ...
        <div class="bottom-content">
            <div class="cart-products">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{asset('front/assets/images/shop/shop01.jpg')}}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{asset('front/assets/images/shop/shop02.jpg')}}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{asset('front/assets/images/shop/shop03.jpg')}}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{asset('front/assets/images/shop/shop04.jpg')}}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{asset('front/assets/images/shop/shop05.jpg')}}" alt="shop"></a>
                    </div>
                    <div class="content">
    ...
    <section class="banner-section-4 bg_img oh" data-background="{{asset('front/assets/images/banner/banner-bg-4.png')}}">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="banner-thumb-4">
                        ...
                        <img src="{{asset('front/assets/images/banner/banner-4.png')}}" alt="banner">
                    </div>
                </div>
            </div>
        </div>
        <div class="banner-shape d-none d-lg-block bot-0">
            <img src="{{asset('front/assets/css/img/banner-shape-4.png')}}" alt="css">
        </div>
    </section>
    ...
    <section class="how-section padding-top padding-bottom pos-rel">
        <div class="container">
            ...
            <div class="row justify-content-center mb--40">
                <div class="col-md-6 col-lg-4">
                    <div class="how-item">
                        <div class="how-thumb">
                            <img src="{{asset('front/assets/images/how/how1.png')}}" alt="how">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="how-item">
                        <div class="how-thumb">
                            <img src="{{asset('front/assets/images/how/how2.png')}}" alt="how">
                        </div>
                        <div class="how-content">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="how-item">
                        <div class="how-thumb">
                            <img src="{{asset('front/assets/images/how/how3.png')}}" alt="how">
                        </div>
                        <div class="how-content">
        ...
        <div class="car-2 d-none d-lg-block"><img src="{{asset('front/assets/images/how/car2.png')}}" alt="how"></div>
    </section>
    <!--============= How Section Starts Here =============-->
    ...
    <section class="car-auction-section padding-bottom pos-rel oh">
        <div class="car-bg"><img src="{{asset('front/assets/images/auction/car/car-bg.png')}}" alt="car"></div>
        <div class="container">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('front/assets/images/auction/car/auction-1.jpg')}}" alt="car"></a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('front/assets/images/auction/car/auction-2.jpg')}}" alt="car"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        <div class="auction-thumb">
                            <a href="product-details.html"><img src="{{asset('front/assets/images/auction/car/auction-3.jpg')}}" alt="car"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/trending/auction-1.png')}}" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/trending/auction-2.png')}}" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/trending/auction-3.png')}}" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/trending/auction-4.png')}}" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
    ...
    <section class="ending-auction padding-top pos-rel">
        <div class="popular-bg bg_img" data-background="{{asset('front/assets/images/auction/popular/popular-bg.png')}}"></div>
        <div class="container">
                ...
                <div class="row justify-content-center mb-40-none">
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction01.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.html">2020 Honda Insight,
                                        Touring</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction02.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction03.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction04.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction05.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            <div class="auction-thumb">
                                <a href="product-details.html"><img src="{{asset('front/assets/images/auction/ending/auction06.png')}}" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
    ...
    <section class="call-in-section padding-top">
        <div class="container">
            <div class="call-wrapper cl-white bg_img" data-background="{{asset('front/assets/images/call-in/call-bg.png')}}">
                ...
                <div class="client-slider owl-theme owl-carousel">
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{asset('front/assets/images/client/client01.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{asset('front/assets/images/client/client02.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{asset('front/assets/images/client/client03.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
    ...
    <footer class="bg_img padding-top oh" data-background="{{asset('front/assets/images/footer/footer-bg.jpg')}}">
        <div class="footer-top-shape">
            <img src="{{asset('front/assets/css/img/footer-top-shape.png')}}" alt="css">
        </div>
        <div class="anime-wrapper">
            <div class="anime-1 plus-anime">
                <img src="{{asset('front/assets/images/footer/p1.png')}}" alt="footer">
            </div>
            <div class="anime-2 plus-anime">
                <img src="{{asset('front/assets/images/footer/p2.png')}}" alt="footer">
            </div>
            <div class="anime-3 plus-anime">
                <img src="{{asset('front/assets/images/footer/p3.png')}}" alt="footer">
            </div>
            <div class="anime-5 zigzag">
                <img src="{{asset('front/assets/images/footer/c2.png')}}" alt="footer">
            </div>
            <div class="anime-6 zigzag">
                <img src="{{asset('front/assets/images/footer/c3.png')}}" alt="footer">
            </div>
            <div class="anime-7 zigzag">
                <img src="{{asset('front/assets/images/footer/c4.png')}}" alt="footer">
            </div>
        </div>
            ...
            <div class="container">
                <div class="newslater-area">
                    <div class="newslater-thumb">
                        <img src="{{asset('front/assets/images/footer/newslater.png')}}" alt="footer">
                    </div>
            ...
            <div class="container">
                <div class="copyright-area">
                    <div class="footer-bottom-wrapper">
                        <div class="logo">
                            <a href="index.html"><img src="{{asset('front/assets/images/logo/footer-logo.png')}}" alt="logo"></a>
                        </div>
                        <ul class="gateway-area">
                            <li>
                                <a href="#0"><img src="{{asset('front/assets/images/footer/paypal.png')}}" alt="footer"></a>
                            </li>
                            <li>
                                <a href="#0"><img src="{{asset('front/assets/images/footer/visa.png')}}" alt="footer"></a>
                            </li>
                            <li>
                                <a href="#0"><img src="{{asset('front/assets/images/footer/discover.png')}}" alt="footer"></a>
                            </li>
                            <li>
                                <a href="#0"><img src="{{asset('front/assets/images/footer/mastercard.png')}}" alt="footer"></a>
                            </li>
                        </ul>
                        <div class="copyright"><p>&copy; Copyright 2020 | <a href="#0">Sbidu</a> By <a href="#0">Uiaxis</a></p></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{asset('front/assets/js/yscountdown.min.js')}}"></script>
    <script src="{{asset('front/assets/js/jquery-ui.min.js')}}"></script>
    <script src="{{asset('front/assets/js/main.js')}}"></script>
</body>


<!-- Mirrored from pixner.net/sbidu/main/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Oct 2020 09:38:37 GMT -->
</html>
